...
var Fretboard = function(settings) {
settings = settings || defaultSettings;
var where = settings.where || fretboardHTML; // logical operator "||" use requires this element/id's existence on page prior to firing off javascript.

/* Test value from fretboard */
d3.select("#fretboard-wrap")
  .append("p")
  .text('Yo!');
